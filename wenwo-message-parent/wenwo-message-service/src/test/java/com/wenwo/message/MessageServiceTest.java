...
public class MessageServiceTest {
	...
	public void newMatchedUser(){
		...
		//String targetUid = "4fd6ee650cf25307861858fb";	
		//String targetUid = "5284660ce4b007cd897f27d9";  //腾讯
		
		String questionId = "uATNQq0p"; //常用
...
//		map.put("oriWeiboId", "348034089078440");
	...
	public void newAnswer(){
		...
		//String targetUid = "527515d4e4b0ac17cf3b3244"; //测试机
		//String answerId = "53f18a8be4b03c881854569a";
		
		String targetUid = "4fd5509b0cf253078618551c";   
		String answerId = "5450a40b84ae73b0fb55727b";  
	...
	public void syncAnswer(){
		...
		MessageParameter parameter = new MessageParameter(answerId, IdType.ANSWER, map);
		messageService.share(shareType, actionUid, SubprojectType.DOCTOR, parameter);
	}
	...
	public void doctorHavingQuestion(){
		...
		String targetUid =   "527515d4e4b0ac17cf3b3244";  //
		//String targetUid =   "53c48698e4b06252585831f7";  //
	...
	public void doctorAuditSuccess(){
		...
		String targetUid =   "527515d4e4b0ac17cf3b3244";  //
		//String targetUid =   "4fd16fcfe4b0c645f66832db";  //
	...
	public void doctorComment(){
        ...
        Map<String,Object> map = new HashMap<String,Object>();
		map.put("backgroud", true);
		map.put("doctorCommentWeiboId", "3745650048643190");   //微博id
	 ...
	 */
	@Test
	public void doctorNonProfessional(){
		String messageType = "doctorNonProfessional";
		String targetUid = "527515d4e4b0ac17cf3b3244";  //
	 ...
	 */
	@Test
	public void patientTipAnswer(){
		String messageType = "patientTipAnswer";
		//String targetUid =   "527515d4e4b0ac17cf3b3244";  //
		//String targetUid =   "52048e56e4b05313d4b421df";  // IPHONE
		String targetUid =   "53b4eeb3e4b08e8e86b9354a";  //   ANDROID
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("mark", "patient");
		String questionId = "1TYm9Gm4mU";   //drquestion测试机
		MessageParameter parameter = new MessageParameter(questionId, IdType.QUESTION, map);
		String msgId = messageService.sendMessage(messageType, targetUid, SubprojectType.DOCTOR, parameter);
		System.out.println(msgId);
	}
	...
	@Test
	public void mytest(){
		String messageType = "mytest";
		String targetUid =   "527515d4e4b0ac17cf3b3244"; 
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("flag", "true");
		MessageParameter parameter = new MessageParameter(targetUid, IdType.USER, map);
		String messgeId = messageService.sendMessage(messageType, targetUid, SubprojectType.DOCTOR, parameter);
		System.out.println(messgeId);
	}
...
//			env.put("PATH", path + ":/opt/local/bin");
	...
	public void specialBGMessage(){
		...
		map.put("specialBGString", "@赖stronger fdsfsdafsadf");
