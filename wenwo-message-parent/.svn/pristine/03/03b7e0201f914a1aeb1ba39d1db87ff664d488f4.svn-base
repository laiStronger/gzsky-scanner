...
public class XingeAppUtil {
	...
	public static Message xingePatientMessage(MessageRequest request,String content){
	 ...
	 * @param deviceToken
	 */
	public static JSONObject sendXingeMessage(Message message,String deviceToken,String flag) {
        int accessId = Integer.parseInt(PropertyUtil.readValue("patientAccessId"));
        String secretkey = PropertyUtil.readValue("patientSecretkey");
