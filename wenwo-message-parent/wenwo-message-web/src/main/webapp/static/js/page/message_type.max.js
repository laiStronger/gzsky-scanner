...
window.MT=(function () {
	...
	change_message_type.on("click",function(){
		if(confirm("确定修改吗？")){
			...
			//阿里信息
			var exter_exter_message =$("#mexter_"+id)[0].checked;
			var exter_exter_allnot =$("#mexterallnot_"+id)[0].checked;
			
			if(exter_exter_message && !exter_exter_allnot){
				param.exter_notice="exter";
			}else{
				param.exter_notice="allnot";
			}
