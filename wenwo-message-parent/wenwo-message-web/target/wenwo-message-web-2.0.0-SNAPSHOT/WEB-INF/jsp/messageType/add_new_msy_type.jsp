...
<!-- 使用这个js -->
<script type="text/javascript" src="../static/js/page/new_msg_type.max.js"></script>
				...
				<form id="new_message_type_form" class="form-horizontal well">
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input id="insiteWebTemplateInfo-isNeed" value="需要" type="checkbox"> 需要 </label>
							</div>
						</div>
						...
						<div id="INSITE_WEB" style="display: none;">
							...
							<div class="controls">
								<div class="textarea">
									<textarea id="insiteWebTemplateInfo" type="" class="" style="width:400px;height:130px;"> </textarea>
									<a info_type="INSITE_WEB" class="btn btn-info edit_text_template">可视化编辑</a>
								</div>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input id="insiteAppTemplateInfo-isNeed" value="需要" type="checkbox"> 需要
								</label>
							</div>
						...
						<div id="INSITE_APP" style="display: none;">
							...
							<div class="controls">
								<div class="textarea">
									<textarea id="insiteAppTemplateInfo" type="" class="" style="width:400px;height:130px;"> </textarea>
									<a info_type="INSITE_APP" class="btn btn-info edit_text_template">可视化编辑</a>
								</div>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input id="pushTemplateInfo-isNeed" value="需要" type="checkbox"> 需要
								</label>
							</div>
						...
						<div id="PUSH" style="display: none;">
							...
							<div class="controls">
								<div class="textarea">
									<textarea id="pushTemplateInfo" type="" class="" style="width:400px;height:130px;"> </textarea>
						...
						<div class="control-group">
							...
							<div id="weibo_message_radio" class="controls">
								<label class="radio inline"> 
									<input checked value="normal" name="weibo_message" type="radio"> 正常@通知
								</label>
								<label type="collect" class="radio inline">
									<input value="collect" name="weibo_message" type="radio"> 集合消息
								</label>
								<label class="radio inline">
									<input value="no_send" name="weibo_message" type="radio"> 不发送
								</label>
							</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<div  id="WEIBO" class="textarea">
									<textarea id="weibo_template_text" type="" class="" style="width:400px;height:130px;"> </textarea>
						...
						<div class="control-group">
							...
							<div id="channel_cfg" class="controls">
								...
								<label class="radio inline"> <input value="specific"
						...
						<div id="channel" style="display:none">
							<div class="control-group">
								...
								<div class="controls">
									...
									<select id="sinaGroupName" class="input-xlarge">
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<select id="qqGroupName" class="input-xlarge">
										<option value="C1">C1</option>
										<option value="C2">C2</option>
										<option value="C3">C3</option>
										<option value="C4">C4</option>
					...
					<div class="control-group">
						...
						<div id="primessage_message_radio" class="controls">
							<label class="radio inline"> 
								<input checked value="normal" name="pri_message" type="radio"> 正常通知
							</label>
							<label class="radio inline">
								<input value="no_send" name="pri_message" type="radio"> 不发送
							</label>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<div  id="PRIMESSAGE" class="textarea">
								<textarea id="primessage_template_text" type="" class="" style="width:400px;height:130px;"> </textarea>
								<a info_type="PRIMESSAGE" class="btn btn-info edit_text_template">可视化编辑</a>
							</div>
						</div>
					</div>
					<!-- 短信通知模板 -->
				   <div class="control-group">
						...
						<div id="sms_message_radio" class="controls">
							<label class="radio inline"> 
								<input checked value="normal" name="sms_message" type="radio"> 正常通知
							</label>
							<label class="radio inline">
								<input value="no_send" name="sms_message" type="radio"> 不发送
							</label>
						</div>
					</div>
				    <div class="control-group">
						...
						<div class="controls">
							<div  id="SMS" class="textarea">
								<textarea id="sms_template_text" type="" class="" style="width:400px;height:130px;"> </textarea>
					...
					<a id="submit_message_type" href="javascript:void(0)" name="message" class="">保存配置</a>
				</form>
			</div>
		</div>
		<!-- 遮罩层 -->
